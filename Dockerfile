...
RUN (crontab -l ; echo "0 8 * * 1-5 cd /SyncIdentity && ./osv-scanner_1.3.2_linux_amd64 --lockfile ./identity-server-poc/poetry.lock > /SyncIdentity/scan_output.txt") | crontab
